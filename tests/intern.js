...
define({
	...
	// the AMD loader in use can be used here.
	// If you want to use a different loader than the default loader, see
	// <https://theintern.github.io/intern/#option-useLoader> for instruction
	loaderOptions: {
			paths : {
				Utility: 'src/app/js/es6/modules/Utility'
			}
	},

	// Non-functional unit test suite(s) to run in each browser
	suites: [
		'tests/unit/testDataArrayToRLE',
		'tests/unit/testParseRLEPixelString',
		'tests/unit/testUtility'
	],
